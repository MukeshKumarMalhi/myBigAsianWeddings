...
<div class="bg-center-url bg-dark bg-overlay-dark" style="background-image: url('{{ asset('web_asset/images/bg-header1.jpg') }}');">
  <?php } ?>
    ...
    <header class="fixed-top-not">
        <nav class="navbar navbar-expand-lg <?php if (Route::getCurrentRoute()->uri() == '/'){ echo 'navbar-dark shadow-none'; } ?> text-left">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('web_asset/images/mybigasianwedding-logo.png') }}" class="img-fluid"></a>
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    <ul class="nav bs-menu navbar-nav ml-lg-auto justify-content-lg-end">
                        <li class="nav-item dropdown dropdown-hover">
                            ...
                            <a class="nav-link" href="events.html">Inspiration</a>
                        ...
                        <li class="nav-item dropdown dropdown-hover">
                            <span class="dropdown-icon-right dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" ></span>
                            <a class="nav-link" href="wedding_venues.html">Venues</a>
                            <ul class="dropdown-menu">
