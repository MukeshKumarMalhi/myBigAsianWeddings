    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid py-3" id="categories">
          ...
          <div class="card">
            ...
            <div class="table-responsive small p-4" style="font-weight: 600; line-height: 2; font-size: 18px;">
              <?php
                foreach ($sections as $key => $value) {
                  echo "Section: ".  "-$value->section_name"."<br/>";
                  foreach ($value->questions as $key => $val) {
                    echo "Question: "."--$val->question_name ($val->type)"."<br/>";
                    if($val->type == "text" || $val->type == "file"){
                      echo "<input type='$val->type' name='$val->question_name' class='form-control'>"."<br/>";
                    }
                    // if($val->type == "textarea")
                    foreach ($val->answers as $key => $answer) {
                      if($val->type == "checkbox" || $val->type == "radio"){
                        echo "<input type='$val->type' name='$val->question_name[]' value='$answer->answer_name' class='form-control' style='display: inline-block;'> "."$answer->answer_name"."<br/>";
                      }
                      // echo "Answer: "."---$answer->answer_name"."<br/>";
                    }
                  }
                  echo "<hr/>";
                }
